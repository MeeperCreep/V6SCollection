...
class VideoState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (crashMoment > 0)
			crashMoment--;
		// special thanks to bob and bosip for this code, couldn't imagine an unskippable cutscene X^X
		// ah, the benefits of being opensource... oh wait... im opensourcing this too, oh shit, someone is probably reading this aaa-
